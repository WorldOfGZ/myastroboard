...
- Run SkyTonight every 6 hours for each selected target
- Store outputs in `./data/skytonight/outputs/`
...
# Scheduling
- SCHEDULE_INTERVAL=21600  # Run SkyTonight every 6 hours (seconds)
...
- `./data/skytonight/` - SkyTonight main folder
  - `./data/skytonight/outputs/` - Generated plots and reports **organized by catalogue**:
    - `./data/skytonight/outputs/Messier/` - Messier catalogue outputs
    - `./data/skytonight/outputs/Herschel400/` - Herschel400 catalogue outputs
    - `./data/skytonight/outputs/{catalogue}/` - Each catalogue in its own subdirectory
  - `./data/skytonight/configs/` - Generated SkyTonight configurations
